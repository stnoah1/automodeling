        ...
        return function (scene) {
            ...
            scene.traverse(function (object) {
                if (object instanceof THREE.Mesh) {
                    ...
                    if ((geometry instanceof THREE.BoxGeometry)&&(material instanceof THREE.MeshLambertMaterial)) {
                                ...
                                for (var j = 0; j < 3; j++) {
                                    ...
                                    if (typeof geometry.skinIndices !== 'undefined' && geometry.skinIndices.length === 0) {
                                        ...
                                        if (mesh.geometry.morphTargets !== 'undefined') {
                                            ...
                                            for (var mtt = 0; mtt < geometry.morphTargets.length; mtt++) {
                                                //not pretty, but it gets the job done - jc
                                                morphVector.lerp(new THREE.Vector4(morphMatricesX[mtt], morphMatricesY[mtt], morphMatricesZ[mtt], 1), morphMatricesInfluence[mtt]);
                                            }
                                        }
                                        for (var k = 0; k < 4; k++) {
